...
'<form class="form" role="form" action="index.php?action=delete&id=' . htmlspecialchars($post->getId()) . '" method="post">
                                    <div class="col-lg-12 text-center"><p style="color:#FF0000";><strong>CONFIRMATION</strong></p>
                                        <input type="hidden" id="id" name="id" value="' . htmlspecialchars($post->getId()) . '">
                                        <button type="submit" name="delete" class="btn btn-danger">Oui</button>
                                        <a class="btn btn-primary" href="index.php?action=viewsinglepost&id=' . htmlspecialchars($post->getId()) .'">Non</a>
                                    </div>
                                </form>'; ?>
